...
<table border="1" class="table table-bordered table-hover">
    ...
    <?php foreach ($products as $product) : ?>
        <tr>
            ...
            <td>
                <a class="btn btn-primary" href="./edit/<?= $product['id'] ?>">Sửa</a>
                <a class="btn btn-danger" href="./delete/<?= $product['id'] ?>" onclick="return confirm('Bạn có chắc chắn muốn xóa?')">Xóa</a>
            </td>
        </tr>
    <?php endforeach; ?>
</table>
